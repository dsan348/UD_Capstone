          ...
          stage ('Build Docker Image & Push To Dockerhub') {
			steps {
               sshPublisher(publishers: [sshPublisherDesc(configName: 'DockerCluster', transfers: [sshTransfer(cleanRemote: false, excludes: '',\
                execCommand: 'docker build -t denisan348/revolveimg:green .', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false,\
            ...
            stage('EKS Publish App') {
                 ...
                 [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'kubectl create deployment capstone-app --image=denisan348/revolveimg:green', execTimeout: 120000,\
